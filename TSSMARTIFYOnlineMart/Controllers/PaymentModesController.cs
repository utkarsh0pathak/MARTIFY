...
namespace TSSMARTIFYOnlineMart.Controllers
{
    public class PaymentModesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PaymentModeID,PaymentModeName")] PaymentMode paymentMode)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PaymentModeID,PaymentModeName")] PaymentMode paymentMode)
        {
            if (ModelState.IsValid)
            {
